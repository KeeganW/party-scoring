...
export const Wavelength = () => {
  ...
  const actions = ({ player }: { player: PlayerType }) => {
    return [
      <GenericScoreCardItem enableMinus={!!params.get('enableMinus')} webSocket={webSocket} player={player} action={'primaryGuessTarget'} title={'Hit Target'} scores={scores} setHistory={setHistory} setScores={setScores} />,
      <GenericScoreCardItem enableMinus={!!params.get('enableMinus')} webSocket={webSocket} player={player} action={'secondaryGuessCorrect'} title={'Correct Side'} scores={scores} setHistory={setHistory} setScores={setScores} />,
      <GenericScoreCardItem enableMinus={!!params.get('enableMinus')} webSocket={webSocket} player={player} action={'secondaryGuessWrong'} title={'Wrong Side'} scores={scores} setHistory={setHistory} setScores={setScores} />,
    ];
  };
